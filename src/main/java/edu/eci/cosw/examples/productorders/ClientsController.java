...
public class ClientsController {
    ...
    @ResponseBody
    public ResponseEntity<List<Cliente>> getAllCLientsByPrice(@PathVariable("price") long productPrice) {
        try {
            return ResponseEntity.ok().body(services.getAllClientsByPrice(productPrice));
