...
public class VehiclesController {
    ...
    @ResponseBody
    public ResponseEntity<List<Vehiculo>> getAllCLientsByPrecioProducto(@PathVariable("id") int idProducto) {
        try {
            return ResponseEntity.ok().body(services.getAllVehiclesByProduct(idProducto));
